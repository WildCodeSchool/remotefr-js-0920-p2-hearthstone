      ...
      <footer>
        <div className="container">
          <div className="footer-container">
            <div className="logo">
              <img
                src="https://d2q63o9r0h0ohi.cloudfront.net/images/npe/header/rose_icon_header-2c41dc61329a7d80e3f277baf149ac1fa7f6ba9b0095cbbec5b39ab21b164bb1c5909a06b6880f75e6d99c15787e4b0f246dd9d78ab8682c3bd5e0f068b0eb63.png"
          ...
          <div className="grid-container">
            <div className="Lien-Blizzard">
              ...
              <p>
                ...
                <a href="#Hearhstone">Hearthstone</a>
              </p>
            </div>
            <div className="Youtube">
              <a
                href="https://www.youtube.com"
                title="Visitez notre page Youtube"
              >
                <p>Youtube</p>

                <svg xmlns="../assets/youtube.svg" alt="Youtube" />
              </a>
            </div>
