      ...
      <div className="secondArticle">
        ...
        <div className="grid-container">
          ...
          <article className="Mana-cost">
            <strong>Mana cost:</strong> the number in blue crystal represent the
            cost in mana for playing the card.
          </article>
          ...
          <article className="Effect">
            <strong>Effect:</strong> some cards have an effect when entering in
            the battlefield or on the battlefield.
          </article>
        </div>
      </div>
    </div>
